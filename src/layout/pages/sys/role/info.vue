<template>
    ...
    >
        <el-form v-loading="loading" ref="roleForm" label-width="80px" :model="form" :rules="rules">
            <el-form-item label="角色名" prop="name">
                <el-input v-model="form.name"></el-input>
            </el-form-item>
            <el-form-item label="标识" prop="mark">
                <el-input v-model="form.mark" :readonly="!form.role_id"></el-input>
            </el-form-item>
                ...
                >
                    <template #default="{ node, data }">
                        <span class="custom-tree-node">
                            <span> ({{ data.type === 'MENU' ? `菜单` : `接口` }}) {{ data.title }} </span>
                        </span>
                    </template>
                </el-tree>
            </el-form-item>
