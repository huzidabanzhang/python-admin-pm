<template>
    ...
    >
        ...
        <!-- 主体内容 -->
        <div
            class="chubby-layout-header-aside-content"
            flex="dir:top"
        >
            <!-- 顶栏 -->
            <div
            ...
            >
                ...
                <!-- 主体 -->
                <div
                    class="chubby-theme-container-main"
                    flex-box="1"
                    flex
                >
                    <!-- 搜索 -->
                ...
                <chubby-panel-search
                    ...
                    <transition name="fade-scale">
                        <div
                            v-if="!searchActive"
                            class="chubby-theme-container-main-layer"
                            flex="dir:top"
                        >
                            <!-- tab -->
                            <div
                                class="chubby-theme-container-main-header"
                                flex-box="0"
                            >
                                <chubby-tabs />
                            </div>
                            <!-- 页面 -->
                            <div
                                class="chubby-theme-container-main-body"
                                flex-box="1"
                            >
