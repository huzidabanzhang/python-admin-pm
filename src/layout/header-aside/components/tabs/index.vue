<template>
    <div class="admin-multiple-page-control-group" flex>
        <div class="admin-multiple-page-control-content" flex-box="1">
        ...
        <div class="admin-multiple-page-control-btn" flex-box="0">
            <el-dropdown
                size="default"
                split-button
...
const contextmenuListIndex = [{ icon: 'times-circle', title: '关闭全部', value: 'all' }]
